...
export const dummyNewsArticles: NewsArticle[] = [
  {
    ...
    summary: 'A preview story showing how a modern inspection line could support consistent quality, safer workflows and future production growth.',
  ...
  },
  {
    ...
    summary: 'This sample update introduces a bright community store concept centred on fresh produce, easier navigation and a warmer shopping experience.',
  ...
  },
  {
    ...
    summary: 'A fictional hospitality feature exploring calm tropical design, local character and thoughtful spaces made for memorable stays.',
...
export const getDummyNewsBySlug = (slug?: string) => dummyNewsArticles.find((article) => article.slug === slug);
