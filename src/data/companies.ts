...
export const companies: Company[] = [
  {
    ...
    fullDescription:
      "Supun Traders is where it all started. Founded in 1978 by Mohamed Fareed, it began as a trading business importing and distributing household appliances and electronics, and grew into the foundation the Group stands on today. In 1999, his son, the current Chairman, Mr. Kaleel, took on that legacy and built it into what is now the Supun Group of Companies. Today, Supun Traders remains a trusted wholesaler and retailer of locally manufactured and imported household goods, home appliances, and electronics.",
  ...
  },
  {
    ...
    tagline: "The Group's Retail Destination.",
  ...
  },
  {
    ...
    tagline: "Luxury Serviced Apartments in Colombo",
    description: "Luxury serviced apartments in central Colombo.",
    fullDescription:
      "Supun Arcade Residency offers fully furnished, air-conditioned suites in the heart of Colombo, each with panoramic ocean or city views. Above the city, a rooftop pool and dining space invite guests to unwind, backed by premium hospitality throughout the stay.",
    industry: "Hospitality",
    established: "2010",
    website: "https://www.supunarcaderesidency.com/",
    features: ["40 luxury suites across 8 floors", "Rooftop pool and dining", "Premium hospitality"],
    phone: "0112 055 040",
  ...
  },
  {
    ...
    features: [
      ...
      "Made in our own factories in Sri Lanka",
