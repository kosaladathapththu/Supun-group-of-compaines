...
export const leadership = [
  ...
  { name: 'Khalid Kaleel', title: 'Director', description: 'Oversees Fuji Industries' },
  {
    name: 'Raiza Kaleel',
    title: 'Director',
    description: 'Oversees the Camy brand and Group marketing.',
  },
  {
    name: 'Lasitha Samarasinghe',
    title: 'Group Chief Financial Officer',
    description:
      'Oversees financial strategy, treasury, compliance, and governance across the Supun Group.',
  },
  {
    name: 'Mohamed Riaz Farouk',
    title: 'Group Chief Executive Officer',
    description:
      'Oversees overall operations and performance across Rodsons, Aero Star, Camy Smart, and New Camy Smart',
  },
  {
    name: 'Jeewantha Perera',
    title: 'Head of Hospitality & Business Development',
    description:
      'Oversees hotel operations, guest experience, and business development across Supun Arcade Residency and Area 56.',
  },
  {
    name: 'Eranga Rodrigo',
    title: 'Director, Rodsons',
    description: 'Oversees plastic injection moulding and manufacturing operations at Rodsons.',
  },
];
...
export const journey = [
  [
    '1978',
    'Mohamed Fareed founds Supun Traders, trading household goods, appliances and electronics',
  ],
  ...
  [
    '2010',
    "Supun Arcade Residency opens, the Group's first step into hospitality, with Area 56 rooftop dining",
  ],
  ['2011', "Supun Aerosoft founded, Sri Lanka's first PU footwear manufacturer"],
  [
    '2016',
    'Aero Star founded, bringing chrome plating and Camy-branded appliance manufacturing in-house',
  ],
  [
    '2017',
    'Camy Smart and Rodsons founded, helmet manufacturing and the components that support it',
  ],
  ['2018', 'New Camy Smart founded, adding non-stick cookware manufacturing'],
  [
    '2023',
    "Fuji Industries founded, the Group's newest venture, manufacturing air conditioners and fans",
  ],
  [
    'Today',
    '11 companies across manufacturing, retail, distribution, and hospitality, employing 300+ people',
  ],
] as const;
...
export const coreValues = [
  {
    ...
    description: 'A consistent standard across every company, product, and service.',
  },
  {
    title: 'People First',
    description: 'Building businesses that serve customers, employees, partners, and communities.',
  },
  {
    title: 'Innovation',
    description:
      'Using technology, new ideas, and manufacturing capability to keep moving forward.',
  },
  {
    title: 'Sri Lankan Pride',
    description:
      'Manufacturing locally, meeting international standards, and reinvesting in Sri Lankan industry and jobs.',
  },
];
