  ...
  return (
    <main className="contact-page min-h-screen text-[#10233f]">
      ...
      <style>{`
        ...
        .company-logo-zone{position:relative;display:flex;height:132px;align-items:center;justify-content:center;overflow:hidden;border-bottom:1px solid rgba(16,35,63,.08);background:color-mix(in srgb,var(--brand) 7%,white)}.company-logo-zone::after{content:"";position:absolute;width:160px;height:160px;border:28px solid color-mix(in srgb,var(--brand) 8%,transparent);border-radius:50%;right:-70px;top:-88px}.company-logo{position:relative;z-index:1;width:250px;height:108px;background:transparent!important}.company-logo img{width:100%;height:100%;max-width:none!important;max-height:none!important;object-fit:contain;mix-blend-mode:multiply;transform:scale(1.75)}.company-card-body{display:flex;flex:1;flex-direction:column;padding:22px 24px 20px}.company-sector{color:var(--brand);background:color-mix(in srgb,var(--brand) 8%,white);border-color:color-mix(in srgb,var(--brand) 18%,white)}
        .company-contact-row{display:flex;min-height:43px;align-items:center;gap:10px;border-top:1px solid rgba(16,35,63,.08);padding-top:14px;color:#53657b}.company-contact-row>svg{color:var(--brand)}.company-action{display:flex!important;width:auto!important;height:44px!important;align-items:center!important;justify-content:center!important;gap:9px;padding:0 18px!important;border-radius:13px;background:var(--brand);color:#fff;font-size:12px;font-weight:800;white-space:nowrap;box-shadow:0 8px 20px color-mix(in srgb,var(--brand) 22%,transparent);transition:.25s ease}.company-action svg{position:static!important;inset:auto!important;display:block!important;margin:0!important;transform:none!important;color:currentColor!important}.company-action .action-arrow{opacity:.65;transition:transform .25s ease}.company-card:hover .company-action{filter:brightness(.92);transform:translateY(-2px)}.company-card:hover .company-action .action-arrow{transform:translate(2px,-2px)!important}
