  ...
  return (
    <main className="contact-page min-h-screen text-[#10233f]">
      ...
      <style>{`
        ...
        .company-action{display:flex!important;align-items:center!important;justify-content:center!important;width:48px;height:48px;padding:0!important;border-radius:999px;background:#10233f;color:#fff;transition:.25s ease}.company-action svg{position:static!important;inset:auto!important;display:block!important;margin:0!important;transform:none!important}.company-card:hover .company-action{background:#78be43;color:#10233f}
      ...
      <style>{`.company-card a{display:flex!important;align-items:center!important;justify-content:center!important;width:48px!important;height:48px!important;padding:0!important}.company-card a svg{position:static!important;inset:auto!important;margin:0!important;transform:none!important}`}</style>
