...
import { ArrowLeft, CircleAlert, Layers, Store } from 'lucide-react';
...
function getVariationColorOptions(
...
export default function ProductDetail() {
  ...
  const displayPrice = activeVariation
    ? Number(activeVariation.price || 0)
    ...
    <div className="relative overflow-hidden bg-slate-50">
      <Seo
        ...
        description={
          ...
          `Buy ${product.title} from Supun Group of Companies.`
        }
          ...
          <div className="space-y-5">
                  ...
                  <span className="inline-flex items-center gap-2">
                    {getSafeColorValue(activeVariation.color) && (
                      <span
                        ...
                        style={{
                          backgroundColor:
                            getSafeColorValue(activeVariation.color) || 'transparent',
                        }}
                        title={activeVariation.color || undefined}
                        aria-label={
                          activeVariation.color ? `Color ${activeVariation.color}` : 'Color'
                        }
                      />
                    )}
            ...
            <div className="rounded-2xl border border-primary/10 bg-white p-5">
              ...
              <p className="text-xl font-semibold text-amber-600 mt-1">
                {formatCurrency(displayWholesalePrice)}
              </p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-2">
                        {variationColorOptions.map((colorOption) => {
                          const isSelected =
                            selectedColor === colorOption.label.trim().toLowerCase();
