  ...
  <div className="min-h-screen overflow-hidden bg-[#edf3fb]">
    ...
    <section className="premium-hero relative isolate min-h-[calc(100svh-5rem)] bg-[#04142d] text-white">
      ...
      <div className="container relative z-10 mx-auto flex min-h-[calc(100svh-5rem)] flex-col justify-between px-4 py-8 md:py-12">
        ...
        <div className="hero-copy max-w-5xl py-16 md:py-24">
        ...
        <div className="flex items-end justify-between gap-6">
          ...
          <div className="glass-panel ml-auto grid w-full max-w-2xl grid-cols-2 overflow-hidden md:grid-cols-4">
    ...
    <section id="legacy" className="blueprint-bg relative py-24 md:py-32">
    ...
    <section className="relative bg-[radial-gradient(circle_at_top_right,#174c96_0%,#092654_32%,#04142d_75%)] py-24 text-white md:py-32"><div className="container mx-auto px-4">
