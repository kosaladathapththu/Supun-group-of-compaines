        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <Link to="/" className="mb-5 inline-block">
              <img
                ...
                className="h-20 w-auto drop-shadow-[0_2px_8px_rgba(0,0,0,.25)]"
              />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/75">
              ...
              <li>
                <Link to="/companies" className="hover:text-accent">
                  Our Companies
                </Link>
              </li>
              <li>
                <Link to="/camy-products" className="hover:text-accent">
                  Camy Products
                </Link>
              </li>
              <li>
