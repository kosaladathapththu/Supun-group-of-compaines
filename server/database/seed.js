...
// Company data from the existing data file
const companies = [
  {
    id: "supun-traders",
  ...
  },
  {
    ...
    shortName: "Aero Star",
    description:
      "Leading manufacturer of chrome and chrome-plated products for local and international markets.",
    fullDescription:
      "Aero Star is pioneering in manufacturing and supplying of chrome and chrome-plated products to the local and international markets. With state-of-the-art manufacturing facilities and stringent quality control measures, we deliver products that meet international standards.",
  ...
  },
  {
    ...
    description:
      "Luxury city apartment hotel in the heart of Colombo with modern amenities.",
    fullDescription:
      "SUPUN ARCADE RESIDENCY is a luxury city apartment hotel located in the heart of Colombo offering all modern luxury. Fully air-conditioned apartments provide a panoramic ocean view, or a dynamic city view to make the stay memorable. The 40-suite complex is equipped with all the amenities the discerning traveler is looking for today.",
  ...
  },
  {
    ...
    description:
      "Sri Lanka's leading motorcycle helmet manufacturer with over 250 island-wide distributors.",
    fullDescription:
      "Specialized in manufacturing motorcycle riding helmets to meet local and international safety standards and comfort for the riders, utilizing the latest technology and manufacturing methodologies under strict quality control measures. CAMY SMART branded helmets have gained market acceptance year on year and today it is one of the largest riding helmet manufacturers in Sri Lanka with over 250 distributors island-wide.",
    industry: "Manufacturing",
    features: [
  ...
  },
  {
    ...
    description:
      "Premier manufacturer of non-stick cookware with Korean technology collaboration.",
    fullDescription:
      "The undisputed leader in the manufacturing of non-stick cookware locally, with the technology adaptation and supervision of Korea. It uses highly purified Aluminum as the base material of its non-stick cookware products, ensuring superior quality and durability.",
    industry: "Manufacturing",
    features: [
...
console.log("🌱 Seeding database with company data...");

const stmt = db.prepare(`
  INSERT OR REPLACE INTO companies (id, name, shortName, description, fullDescription, industry, established, website, features)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
...
for (const company of companies) {
  ...
  console.log(`✅ Added: ${company.shortName}`);
}
